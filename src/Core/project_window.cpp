...
public:
    ...
    void setFlag(PageView *view,
                 QGraphicsItem::GraphicsItemFlag f,
                 bool enabled = true);
    ...
    void enableEditing(PageView *view,
                       bool on = true);
...
void ProjectWindowPrivate::init()
{
    ...
    QAction *newProject =
        file->addAction(QIcon(QStringLiteral(":/Core/img/document-new.png")), ProjectWindow::tr("New Project"));
    newProject->setShortcutContext(Qt::ApplicationShortcut);
    newProject->setShortcut(ProjectWindow::tr("Ctrl+N"));

    QAction *openProject =
        file->addAction(QIcon(QStringLiteral(":/Core/img/document-open.png")), ProjectWindow::tr("Open Project"));
    ...
    m_saveProject =
        file->addAction(QIcon(QStringLiteral(":/Core/img/document-save.png")), ProjectWindow::tr("Save Project"));
    ...
    QAction *saveProjectAs =
        file->addAction(QIcon(QStringLiteral(":/Core/img/document-save-as.png")), ProjectWindow::tr("Save Project As"));

    file->addSeparator();

    QMenu *exportMenu =
        file->addMenu(QIcon(QStringLiteral(":/Core/img/document-export.png")), ProjectWindow::tr("Export To"));

    QAction *exportToPdf =
        exportMenu->addAction(QIcon(QStringLiteral(":/Core/img/application-pdf.png")), ProjectWindow::tr("PDF"));

    QAction *exportToHtml =
        exportMenu->addAction(QIcon(QStringLiteral(":/Core/img/text-html.png")), ProjectWindow::tr("HTML"));

    QAction *exportToSvg =
        exportMenu->addAction(QIcon(QStringLiteral(":/Core/img/image-svg+xml.png")), ProjectWindow::tr("SVG Images"));

    file->addSeparator();

    QAction *quitAction =
        file->addAction(QIcon(QStringLiteral(":/Core/img/application-exit.png")), ProjectWindow::tr("Quit"));
    ...
    m_tabsList->toggleViewAction()->setShortcutContext(Qt::ApplicationShortcut);
    m_tabsList->toggleViewAction()->setShortcut(ProjectWindow::tr("Ctrl+Alt+T"));

    view->addAction(m_propertiesDock->toggleViewAction());
    m_propertiesDock->toggleViewAction()->setShortcutContext(Qt::ApplicationShortcut);
    m_propertiesDock->toggleViewAction()->setShortcut(ProjectWindow::tr("Ctrl+Alt+P"));

    QAction *newForm = new QAction(QIcon(QStringLiteral(":/Core/img/list-add.png")), ProjectWindow::tr("Add Page"), q);
    ...
    m_select =
        m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/edit-select.png")), ProjectWindow::tr("Select"));
    ...
    m_drawLine =
        m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-freehand.png")), ProjectWindow::tr("Draw Line"));
    ...
    m_drawPolyLine = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-polyline.png")),
    ...
    m_drawRect = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-rectangle.png")),
    ...
    m_insertText =
        m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/insert-text.png")), ProjectWindow::tr("Insert Text"));
    ...
    m_insertImage = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/insert-image.png")),
    ...
    m_group = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/merge.png")), ProjectWindow::tr("Group"));
    m_group->setShortcutContext(Qt::ApplicationShortcut);
    m_group->setShortcut(ProjectWindow::tr("Ctrl+G"));

    m_ungroup = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/split.png")), ProjectWindow::tr("Ungroup"));
    m_ungroup->setShortcutContext(Qt::ApplicationShortcut);
    m_ungroup->setShortcut(ProjectWindow::tr("Ctrl+U"));

    m_formToolBar->addSeparator();

    m_strokeColor = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/format-stroke-color.png")),
                                             ProjectWindow::tr("Line Color"));

    m_fillColor =
        m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/fill-color.png")), ProjectWindow::tr("Fill Color"));

    m_drawButton = m_stdItemsToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-pushbutton.png")),
    ...
    m_drawComboBox = m_stdItemsToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-combobox.png")),
    ...
    m_drawRadioButton = m_stdItemsToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-radiobutton.png")),
    ...
    m_drawCheckBox = m_stdItemsToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-checkbox.png")),
    ...
    m_drawHSlider = m_stdItemsToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-hslider.png")),
    ...
    m_drawVSlider = m_stdItemsToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-vslider.png")),
    ...
    m_drawSpinbox = m_stdItemsToolBar->addAction(QIcon(QStringLiteral(":/Core/img/draw-spinbox.png")),
    ...
    m_alignHorizLeft = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/align-horizontal-left.png")),
    ...
    m_alignHorizCenter = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/align-horizontal-center.png")),
    ...
    m_alignHorizRight = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/align-horizontal-right.png")),
    ...
    m_alignVertTop = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/align-vertical-top.png")),
    ...
    m_alignVertCenter = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/align-vertical-center.png")),
    ...
    m_alignVertBottom = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/align-vertical-bottom.png")),
    ...
    m_toTop = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/object-order-front.png")),
    ...
    m_up = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/object-order-raise.png")),
                                    ProjectWindow::tr("Raise"));
    m_up->setShortcutContext(Qt::ApplicationShortcut);
    m_up->setShortcut(ProjectWindow::tr("Ctrl+Up"));

    m_down = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/object-order-lower.png")),
                                      ProjectWindow::tr("Lower"));
    m_down->setShortcutContext(Qt::ApplicationShortcut);
    m_down->setShortcut(ProjectWindow::tr("Ctrl+Down"));

    m_toBottom = m_formToolBar->addAction(QIcon(QStringLiteral(":/Core/img/object-order-back.png")),
    ...
    m_zoomIn = m_zoomToolBar->addAction(QIcon(QStringLiteral(":/Core/img/zoom-in.png")), ProjectWindow::tr("Zoom In"));
    m_zoomIn->setShortcutContext(Qt::ApplicationShortcut);
    m_zoomIn->setShortcut(ProjectWindow::tr("Ctrl+="));

    m_zoomOriginal = m_zoomToolBar->addAction(QIcon(QStringLiteral(":/Core/img/zoom-original.png")),
    ...
    m_zoomOut =
        m_zoomToolBar->addAction(QIcon(QStringLiteral(":/Core/img/zoom-out.png")), ProjectWindow::tr("Zoom Out"));
    ...
    QAction *aboutQt = help->addAction(QIcon(QStringLiteral(":/Core/img/qt.png")), ProjectWindow::tr("About Qt"));

    ProjectWindow::connect(quitAction, &QAction::triggered, q, &ProjectWindow::quit);
    ProjectWindow::connect(m_grid, &QAction::toggled, q, &ProjectWindow::showHideGrid);
    ProjectWindow::connect(snapGrid, &QAction::toggled, q, &ProjectWindow::snapGrid);
    ProjectWindow::connect(m_gridStep, &QAction::triggered, q, QOverload<>::of(&ProjectWindow::setGridStep));
    ProjectWindow::connect(newForm, &QAction::triggered, m_widget, &ProjectWidget::addPage);
    ProjectWindow::connect(newProject, &QAction::triggered, q, &ProjectWindow::newProject);
    ProjectWindow::connect(openProject, &QAction::triggered, q, &ProjectWindow::openProject);
    ProjectWindow::connect(m_saveProject, &QAction::triggered, q, &ProjectWindow::saveProject);
    ProjectWindow::connect(saveProjectAs, &QAction::triggered, q, &ProjectWindow::saveProjectAs);
    ProjectWindow::connect(m_widget, &ProjectWidget::changed, q, &ProjectWindow::projectChanged);
    ProjectWindow::connect(m_select, &QAction::toggled, q, &ProjectWindow::select);
    ProjectWindow::connect(m_drawLine, &QAction::triggered, q, &ProjectWindow::drawLine);
    ProjectWindow::connect(m_drawRect, &QAction::triggered, q, &ProjectWindow::drawRect);
    ProjectWindow::connect(m_drawPolyLine, &QAction::toggled, q, &ProjectWindow::drawPolyline);
    ProjectWindow::connect(m_insertText, &QAction::triggered, q, &ProjectWindow::insertText);
    ProjectWindow::connect(m_insertImage, &QAction::triggered, q, &ProjectWindow::insertImage);
    ProjectWindow::connect(m_group, &QAction::triggered, q, &ProjectWindow::group);
    ProjectWindow::connect(m_ungroup, &QAction::triggered, q, &ProjectWindow::ungroup);
    ProjectWindow::connect(m_strokeColor, &QAction::triggered, q, &ProjectWindow::strokeColor);
    ProjectWindow::connect(m_fillColor, &QAction::triggered, q, &ProjectWindow::fillColor);
    ProjectWindow::connect(m_widget->tabs(), &QTabWidget::currentChanged, q, &ProjectWindow::tabChanged);
    ProjectWindow::connect(exportToPdf, &QAction::triggered, q, &ProjectWindow::exportToPDf);
    ProjectWindow::connect(exportToHtml, &QAction::triggered, q, &ProjectWindow::exportToHtml);
    ProjectWindow::connect(exportToSvg, &QAction::triggered, q, &ProjectWindow::exportToSvg);
    ProjectWindow::connect(about, &QAction::triggered, q, &ProjectWindow::about);
    ProjectWindow::connect(aboutQt, &QAction::triggered, q, &ProjectWindow::aboutQt);
    ProjectWindow::connect(m_drawButton, &QAction::triggered, q, &ProjectWindow::drawButton);
    ProjectWindow::connect(m_drawComboBox, &QAction::triggered, q, &ProjectWindow::drawComboBox);
    ProjectWindow::connect(m_drawRadioButton, &QAction::triggered, q, &ProjectWindow::drawRadioButton);
    ProjectWindow::connect(m_drawCheckBox, &QAction::triggered, q, &ProjectWindow::drawCheckBox);
    ProjectWindow::connect(m_drawHSlider, &QAction::triggered, q, &ProjectWindow::drawHSlider);
    ProjectWindow::connect(m_drawVSlider, &QAction::triggered, q, &ProjectWindow::drawVSlider);
    ProjectWindow::connect(m_drawSpinbox, &QAction::triggered, q, &ProjectWindow::drawSpinbox);
    ProjectWindow::connect(m_alignHorizLeft, &QAction::triggered, q, &ProjectWindow::alignHorizontalLeft);
    ProjectWindow::connect(m_alignHorizCenter, &QAction::triggered, q, &ProjectWindow::alignHorizontalCenter);
    ProjectWindow::connect(m_alignHorizRight, &QAction::triggered, q, &ProjectWindow::alignHorizontalRight);
    ProjectWindow::connect(m_alignVertTop, &QAction::triggered, q, &ProjectWindow::alignVerticalTop);
    ProjectWindow::connect(m_alignVertCenter, &QAction::triggered, q, &ProjectWindow::alignVerticalCenter);
    ProjectWindow::connect(m_alignVertBottom, &QAction::triggered, q, &ProjectWindow::alignVerticalBottom);
    ProjectWindow::connect(m_zoomIn, &QAction::triggered, q, &ProjectWindow::zoomIn);
    ProjectWindow::connect(m_zoomOriginal, &QAction::triggered, q, &ProjectWindow::zoomOriginal);
    ProjectWindow::connect(m_zoomOut, &QAction::triggered, q, &ProjectWindow::zoomOut);
    ProjectWindow::connect(m_duplicate, &QAction::triggered, q, &ProjectWindow::duplicate);
    ProjectWindow::connect(m_widget->undoGroup(), &QUndoGroup::cleanChanged, q, &ProjectWindow::canUndoChanged);
    ProjectWindow::connect(m_widget->descriptionTab()->editor(),
                           &TextEditor::undoAvailable,
                           q,
                           &ProjectWindow::canUndoChanged);
    ProjectWindow::connect(m_widget, &ProjectWidget::pageAdded, q, &ProjectWindow::pageAdded);
    ProjectWindow::connect(m_widget, &ProjectWidget::pageDeleted, q, &ProjectWindow::pageDeleted);
    ProjectWindow::connect(m_toTop, &QAction::triggered, q, &ProjectWindow::toTop);
    ProjectWindow::connect(m_up, &QAction::triggered, q, &ProjectWindow::raise);
    ProjectWindow::connect(m_down, &QAction::triggered, q, &ProjectWindow::lower);
    ProjectWindow::connect(m_toBottom, &QAction::triggered, q, &ProjectWindow::toBottom);
...
void ProjectWindowPrivate::clearEditModeInTexts()
{
...
void ProjectWindowPrivate::setFlag(PageView *view,
                                   QGraphicsItem::GraphicsItemFlag f,
                                   bool enabled)
{
...
void ProjectWindowPrivate::setFlag(const QList<QGraphicsItem *> &children,
                                   QGraphicsItem::GraphicsItemFlag f,
                                   bool enabled)
{
...
void ProjectWindowPrivate::enableEditing(PageView *view,
                                         bool on)
{
    enableEditing(view->page()->childItems(), on);
}

void ProjectWindowPrivate::enableEditing(const QList<QGraphicsItem *> &children,
                                         bool on)
{
    foreach (QGraphicsItem *item, children) {
...
void ProjectWindowPrivate::updateCfg()
{
    m_cfg.description().set_tabName(m_widget->projectTabName());

    m_cfg.description().set_text(m_widget->descriptionTab()->editor()->text());
...
void ProjectWindowPrivate::cleanPages()
{
    m_addedForms.clear();
...
ProjectWidget *ProjectWindow::projectWidget() const
{
    return d->m_widget;
}

const QString &ProjectWindow::projectFileName() const
{
    return d->m_fileName;
}

QAction *ProjectWindow::showHideGridAction() const
{
    return d->m_grid;
}

QAction *ProjectWindow::gridStepAction() const
{
    return d->m_gridStep;
}

TabsList *ProjectWindow::tabsList() const
{
    return d->m_tabsList;
}

const QString &ProjectWindow::author() const
{
    return d->m_author;
}

void ProjectWindow::setAuthor(const QString &name)
{
    d->m_author = name;
}

void ProjectWindow::readProject(const QString &fileName)
{
    QFile file(fileName);
    ...
    if (file.open(QIODevice::ReadOnly)) {
        try {
            ...
            setWindowTitle(tr("Prototyper - %1[*]").arg(QFileInfo(fileName).baseName()));
        ...
        QMessageBox::warning(this, tr("Unable to Read Project..."), tr("Unable to read project.\nUnable to open file"));
    }
}
...
void ProjectWindow::switchToPolylineMode()
{
    d->m_drawPolyLine->setChecked(true);
}

void ProjectWindow::switchToSelectMode()
{
...
void ProjectWindow::showHideGrid(bool show)
{
...
void ProjectWindow::snapGrid(bool on)
{
    foreach (PageView *view, d->m_widget->pages()) {
...
void ProjectWindow::setGridStep(int step,
                                bool forAll)
{
    ...
    if (dlg.exec() == QDialog::Accepted) {
        if (dlg.applyForAllForms()) {
            ...
            d->m_widget->pages()[index - 1]->page()->setGridStep(dlg.gridStep());
        }
    }
}

void ProjectWindow::setGridStep()
{
    const int index = d->m_widget->tabs()->currentIndex();
...
void ProjectWindow::openProject()
{
    const QString fileName = QFileDialog::getOpenFileName(
        this,
        tr("Select Project to Open..."),
        (d->m_openFolder.isEmpty() ? QStandardPaths::standardLocations(QStandardPaths::DocumentsLocation).constFirst()
                                   : d->m_openFolder),
...
void ProjectWindow::saveProjectImpl(const QString &fileName)
{
    ...
    if (!d->m_fileName.isEmpty()) {
        ...
        if (file.open(QIODevice::WriteOnly)) {
            try {
                ...
                d->m_widget->descriptionTab()->editor()->document()->clearUndoRedoStacks();
...
void ProjectWindow::projectChanged()
{
...
void ProjectWindow::drawPolyline(bool on)
{
    d->clearEditModeInTexts();
...
void ProjectWindow::insertImage()
{
    d->clearEditModeInTexts();
    ...
    if (!fileName.isEmpty()) {
        ...
        if (!image.isNull()) {
            ...
            if (s.width() > 50 || s.height() > 50) {
                ...
                p = QPixmap::fromImage(image.scaled(s, Qt::KeepAspectRatio, Qt::SmoothTransformation));
            } else {
            ...
            QMessageBox::warning(this, tr("Wrong Image..."), tr("Failed to load image from \"%1\".").arg(fileName));
        }
    }
}

void ProjectWindow::group()
{
    PageAction::instance()->page()->group();
}

void ProjectWindow::ungroup()
{
    PageAction::instance()->page()->ungroup();
}

void ProjectWindow::select(bool checked)
{
...
void ProjectWindow::fillColor()
{
    ...
    c = QColorDialog::getColor(c, this, tr("Select Fill Color..."), QColorDialog::ShowAlphaChannel);

    if (c.isValid()) {
        PageAction::instance()->setFillColor(c);

        if (PageAction::instance()->page()) {
            QList<QGraphicsItem *> selected = PageAction::instance()->page()->scene()->selectedItems();
...
void ProjectWindow::strokeColor()
{
    const auto idx = d->m_widget->tabs()->currentIndex();
    ...
    c = QColorDialog::getColor(c, this, tr("Select Stroke Color..."), QColorDialog::ShowAlphaChannel);
...
void ProjectWindow::tabChanged(int index)
{
    ...
    if (index > 0) {
        ...
        PageAction::instance()->setPage(d->m_widget->pages().at(index - 1)->page());
...
void ProjectWindow::zoomChanged()
{
...
void ProjectWindow::selectionChanged()
{
    ...
    if (!fileName.isEmpty()) {
        ...
        if (canModify) {
            ...
            QMessageBox::critical(this,
                                  tr("Unable to export..."),
                                  tr("Unable to save file %1.\nFile is not writable.").arg(fileName));
        }
    }
}

void ProjectWindow::exportToHtml()
{
    if (isWindowModified()) {
        QMessageBox::StandardButton btn = QMessageBox::question(this,
                                                                tr("Project Modified..."),
...
void ProjectWindow::exportToSvg()
{
    if (isWindowModified()) {
        QMessageBox::StandardButton btn = QMessageBox::question(this,
                                                                tr("Project Modified..."),
    ...
    if (!dirName.isEmpty()) {
        try {
            ...
            QMessageBox::critical(this, tr("Unable to export..."), e.what());
        }
    }
}

void ProjectWindow::about()
{
...
void ProjectWindow::aboutQt()
{
    QMessageBox::aboutQt(this);
}

void ProjectWindow::drawButton()
{
    d->clearEditModeInTexts();
...
void ProjectWindow::drawComboBox()
{
    d->clearEditModeInTexts();
...
void ProjectWindow::drawRadioButton()
{
    d->clearEditModeInTexts();
...
void ProjectWindow::drawCheckBox()
{
    d->clearEditModeInTexts();
...
void ProjectWindow::drawHSlider()
{
    d->clearEditModeInTexts();
...
void ProjectWindow::drawVSlider()
{
    d->clearEditModeInTexts();
...
void ProjectWindow::drawSpinbox()
{
    d->clearEditModeInTexts();
...
void ProjectWindow::alignVerticalTop()
{
    PageAction::instance()->page()->alignVerticalTop();
}

void ProjectWindow::alignVerticalCenter()
{
    PageAction::instance()->page()->alignVerticalCenter();
}

void ProjectWindow::alignVerticalBottom()
{
    PageAction::instance()->page()->alignVerticalBottom();
}

void ProjectWindow::alignHorizontalLeft()
{
    PageAction::instance()->page()->alignHorizontalLeft();
}

void ProjectWindow::alignHorizontalCenter()
{
    PageAction::instance()->page()->alignHorizontalCenter();
}

void ProjectWindow::alignHorizontalRight()
{
    PageAction::instance()->page()->alignHorizontalRight();
}

void ProjectWindow::canUndoChanged(bool canUndo)
{
    Q_UNUSED(canUndo)
...
void ProjectWindow::pageAdded(Prototyper::Core::PageView *form)
{
    d->m_addedForms.append(form);
}

void ProjectWindow::pageDeleted(Prototyper::Core::PageView *form)
{
...
void ProjectWindow::zoomIn()
{
    const int index = d->m_widget->tabs()->currentIndex() - 1;

    d->m_widget->pages().at(index)->setScaleValue(d->m_widget->pages().at(index)->scaleValue()
                                                  + PageView::zoomFactor());
...
void ProjectWindow::zoomOriginal()
{
    const int index = d->m_widget->tabs()->currentIndex() - 1;
                ...
                if (o) {
                    ...
                    n->setPosition(n->position()
                                       + QPointF(MmPx::instance().fromMmX(d->m_cfg.defaultGridStep()),
                                                 MmPx::instance().fromMmX(d->m_cfg.defaultGridStep())),
                                   false);
...
//! Change Z index.
void changeZ(const QList<QGraphicsItem *> &s,
             qreal delta,
             Page *page)
{
