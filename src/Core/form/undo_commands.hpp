...
class UndoCreate final : public QUndoCommand
{
public:
    UndoCreate(Page *f,
               const QString &id)
    ...
    {
        if (m_undone) {
            Elem *elem = dynamic_cast<Elem *>(m_form->createElement<Elem>(m_id));
...
//! Undo create.
template<>
class UndoCreate<FormText, Cfg::Text> final : public QUndoCommand
{
public:
    UndoCreate(Page *f,
               const QString &id)
    ...
    {
        if (m_undone) {
            FormText *elem = dynamic_cast<FormText *>(m_form->createElement<FormText>(m_id));
            ...
            QObject::connect(elem->document(), &QTextDocument::undoCommandAdded, m_form, &Page::undoCommandInTextAdded);
...
//! Undo move.
class UndoMove final : public QUndoCommand
{
public:
    UndoMove(Page *form,
             const QString &id,
    ...
    void undo() override
    {
        ...
        FormObject *elem = dynamic_cast<FormObject *>(m_form->findItem(m_id));
...
//! Undo resize.
class UndoResize final : public QUndoCommand
{
public:
    UndoResize(Page *form,
               const QString &id,
               const QRectF &oldR,
               const QRectF &newR)
...
//! Undo delete.
template<class Elem, class Config>
class UndoDelete final : public QUndoCommand
{
public:
    UndoDelete(Page *form,
               const Config &c)
    ...
    void undo() override
    {
        ...
        Elem *elem = dynamic_cast<Elem *>(m_form->createElement<Elem>(m_cfg.objectId()));
...
//! Undo delete.
template<>
class UndoDelete<FormText, Cfg::Text> final : public QUndoCommand
{
public:
    UndoDelete(Page *form,
               const Cfg::Text &c)
    ...
    void undo() override
    {
        ...
        FormText *elem = dynamic_cast<FormText *>(m_form->createElement<FormText>(m_cfg.objectId()));
...
//! Undo group.
class UndoGroup final : public QUndoCommand
{
public:
    UndoGroup(Page *form,
              const QString &id);
...
//! Undo ungroup.
class UndoUngroup final : public QUndoCommand
{
public:
...
class UndoAddLineToPoly final : public QUndoCommand
{
public:
...
//! Undo change line.
class UndoChangeLine final : public QUndoCommand
{
public:
    UndoChangeLine(Page *form,
                   const QString &id,
                   const QLineF &oldLine,
...
class UndoChangePen final : public QUndoCommand
{
public:
    UndoChangePen(Page *form,
                  const QString &id,
                  const QPen &oldPen,
                  const QPen &newPen);
...
class UndoChangeBrush final : public QUndoCommand
{
public:
    UndoChangeBrush(Page *form,
                    const QString &id,
...
class UndoChangeTextOnForm final : public QUndoCommand
{
public:
    UndoChangeTextOnForm(Page *form,
                         const QString &id);
...
class UndoChangeTextWithOpts final : public QUndoCommand
{
public:
    UndoChangeTextWithOpts(Page *form,
                           const QString &id,
                           const Cfg::TextStyle &oldOpts,
                           const Cfg::TextStyle &newOpts);
...
class UndoChangeCheckState final : public QUndoCommand
{
public:
    UndoChangeCheckState(Page *form,
                         const QString &id);
...
//! Undo duplicate.
class UndoDuplicate final : public QUndoCommand
{
public:
    UndoDuplicate(Page *form,
                  const QStringList &origIds,
                  const QStringList &duplIds,
                  int gridStep);
...
class UndoChangeZ final : public QUndoCommand
{
public:
    using ZAndIds = QVector<QPair<QString, qreal>>;

    UndoChangeZ(Page *form,
                const ZAndIds &origZ,
                const ZAndIds &newZ);
...
class UndoEditPoly final : public QUndoCommand
{
public:
    UndoEditPoly(Page *form,
                 const QLineF &oldL1,
                 const QLineF &oldL2,
                 const QLineF &newL1,
                 const QLineF &newL2,
